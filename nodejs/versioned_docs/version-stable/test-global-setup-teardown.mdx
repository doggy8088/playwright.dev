...
首先，我們新增一個名為 'setup db' 的新專案。然後，我們給它一個 [testProject.testMatch](https://ollama.com/api/class-testproject.mdx#test-project-test-match) 屬性，以便匹配名為 `global.setup.ts` 的檔案：
