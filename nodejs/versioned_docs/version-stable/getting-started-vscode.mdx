...
從 VS Code marketplace 安裝 [VS Code 擴充套件](https://marketplace.visualstudio.com/items?itemName=ms-playwright.playwright) 或從 VS Code 的 `Extensions` 頁籤。

![Playwright Test for VS Code](https://github.com/microsoft/playwright/assets/13063165/cab54568-3168-4b3f-bf3d-854976594903)
