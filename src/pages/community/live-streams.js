...
var live_streams_1 = require("@site/src/data/live-streams");
var TITLE = 'Live Streams';
var DESCRIPTION = 'Check out the latest Playwright live streams';
function Video() {
    return (<Layout_1.default title={TITLE} description={DESCRIPTION}>
      <main className="margin-vert--lg">
        ...
        <VideoCards_1.default videos={live_streams_1.default}/>
      </main>
    </Layout_1.default>);
}
