...
var conference_videos_1 = require("@site/src/data/conference-videos");
var video_nav_1 = require("@site/src/data/video-nav");
var TITLE = 'Conference Videos';
var DESCRIPTION = 'Check out the latest conference talks on Playwright';
function Video() {
    return (<Layout_1.default title={TITLE} description={DESCRIPTION}>
      <main className="margin-vert--lg">
        ...
        <VideoCards_1.default videos={conference_videos_1.default}/>
      </main>
    </Layout_1.default>);
}
