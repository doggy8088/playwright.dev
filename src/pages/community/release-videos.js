...
var release_videos_1 = require("@site/src/data/release-videos");
var TITLE = 'Release Videos';
var DESCRIPTION = 'Check out the latest Playwright release videos';
function Video() {
    return (<Layout_1.default title={TITLE} description={DESCRIPTION}>
      <main className="margin-vert--lg">
        ...
        <VideoCards_1.default videos={release_videos_1.default}/>
      </main>
    </Layout_1.default>);
}
