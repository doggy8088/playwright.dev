...
var learn_videos_1 = require("@site/src/data/learn-videos");
var TITLE = 'Learn Videos';
var DESCRIPTION = 'Check out the latest videos for learning Playwright';
function Video() {
    return (<Layout_1.default title={TITLE} description={DESCRIPTION}>
      <main className="margin-vert--lg">
        ...
        <VideoCards_1.default videos={learn_videos_1.default}/>
      </main>
    </Layout_1.default>);
}
