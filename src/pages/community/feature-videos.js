...
var feature_videos_1 = require("@site/src/data/feature-videos");
var TITLE = 'Feature Videos';
var DESCRIPTION = 'Check out the latest Playwright feature videos';
function Video() {
    return (<Layout_1.default title={TITLE} description={DESCRIPTION}>
      <main className="margin-vert--lg">
        ...
        <VideoCards_1.default videos={feature_videos_1.default}/>
      </main>
    </Layout_1.default>);
}
