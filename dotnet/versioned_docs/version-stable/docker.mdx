...
我們目前根據以下 [Ubuntu](https://hub.docker.com/_/ubuntu) 版本發布映像:
...
您可以使用 [.NET install script](https://learn.microsoft.com/en-us/dotnet/core/tools/dotnet-install-script) 來安裝不同的 SDK 版本:
