...
| [Expect(Locator).ToContainClassAsync()](/api/class-locatorassertions.mdx#locator-assertions-to-contain-class) | 元素具有指定的 CSS 類別 |
| [Expect(Locator).ToContainTextAsync()](/api/class-locatorassertions.mdx#locator-assertions-to-contain-text) | 元素包含文字 |
| [Expect(Locator).ToHaveAccessibleDescriptionAsync()](/api/class-locatorassertions.mdx#locator-assertions-to-have-accessible-description) | 元素具有匹配的[無障礙描述](https://w3c.github.io/accname/#dfn-accessible-description) |
| [Expect(Locator).ToHaveAccessibleNameAsync()](/api/class-locatorassertions.mdx#locator-assertions-to-have-accessible-name) | 元素具有匹配的[無障礙名稱](https://w3c.github.io/accname/#dfn-accessible-name) |
...
| [Expect(Locator).ToHaveCountAsync()](/api/class-locatorassertions.mdx#locator-assertions-to-have-count) | 清單具有確切的子項目數量 |
...
| [Expect(Locator).ToMatchAriaSnapshotAsync()](/api/class-locatorassertions.mdx#locator-assertions-to-match-aria-snapshot) | 元素匹配提供的 Aria 快照 |
...
| [Expect(Response).ToBeOKAsync()](/api/class-apiresponseassertions.mdx#api-response-assertions-to-be-ok) | 回應具有 OK 狀態 |
