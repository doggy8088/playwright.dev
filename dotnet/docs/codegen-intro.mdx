...
###### 
<ProgressiveImage image={require("../images/getting-started/record-test-csharp.png")} alt="錄製測試" />
...
###### 
<ProgressiveImage image={require("../images/getting-started/pick-locator-csharp.png")} alt="選擇定位器" />
