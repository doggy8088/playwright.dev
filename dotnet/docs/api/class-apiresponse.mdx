...
[APIResponse] 類別代表由 [ApiRequestContext.GetAsync()](/api/class-apirequestcontext.mdx#api-request-context-get) and similar methods.
...
回傳值 the JSON representation of response body.
...
回傳值 the text representation of response body.
