...
| 動作 | 描述 |
| :- | :- |
| [locator.check()](/api/class-locator.mdx#locator-check) | 勾選輸入核取方塊 |
| [locator.click()](/api/class-locator.mdx#locator-click) | 點擊元素 |
| [locator.uncheck()](/api/class-locator.mdx#locator-uncheck) | 取消勾選輸入核取方塊 |
...
| [locator.select_option()](/api/class-locator.mdx#locator-select-option) | 在下拉式選單中選擇選項 |
...
| [expect(locator).to_have_count()](/api/class-locatorassertions.mdx#locator-assertions-to-have-count) | 元素清單具有指定長度 |
