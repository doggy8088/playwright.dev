...
### 新的 API
- [Page.pdf()](/api/class-page.mdx#page-pdf) accepts two new options [setTagged](/api/class-page.mdx#page-pdf-選項-tagged) and [setOutline](/api/class-page.mdx#page-pdf-選項-outline).
