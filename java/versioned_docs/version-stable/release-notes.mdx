...
**其他選項**
- 新方法 [FormData.append()](/api/class-formdata.mdx#form-data-append) 允許 specify repeating fields with the same name in [`setMultipart`](./api/class-requestoptions#request-options-set-multipart) 選項 in `RequestOptions`:
