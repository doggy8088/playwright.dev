...
| [`assertThat(locator).isInViewport()`](/api/class-locatorassertions.mdx#locator-assertions-to-be-in-viewport) | 元素與檢視區相交 |
...
| [`assertThat(locator).hasAttribute()`](/api/class-locatorassertions.mdx#locator-assertions-to-have-attribute) | 元素具有 DOM 屬性 |
| [`assertThat(locator).hasClass()`](/api/class-locatorassertions.mdx#locator-assertions-to-have-class) | 元素具有 class 屬性 |
| [`assertThat(locator).hasCount()`](/api/class-locatorassertions.mdx#locator-assertions-to-have-count) | 清單具有確切的子元素數量 |
| [`assertThat(locator).hasCSS()`](/api/class-locatorassertions.mdx#locator-assertions-to-have-css) | 元素具有 CSS 屬性 |
| [`assertThat(locator).hasId()`](/api/class-locatorassertions.mdx#locator-assertions-to-have-id) | 元素具有 ID |
| [`assertThat(locator).hasJSProperty()`](/api/class-locatorassertions.mdx#locator-assertions-to-have-js-property) | 元素具有 JavaScript 屬性 |
| [`assertThat(locator).hasText()`](/api/class-locatorassertions.mdx#locator-assertions-to-have-text) | 元素符合文字 |
| [`assertThat(locator).hasValue()`](/api/class-locatorassertions.mdx#locator-assertions-to-have-value) | 輸入欄位具有值 |
| [`assertThat(locator).hasValues()`](/api/class-locatorassertions.mdx#locator-assertions-to-have-values) | 選擇框具有已選取的選項 |
| [`assertThat(page).hasTitle()`](/api/class-pageassertions.mdx#page-assertions-to-have-title) | 頁面具有標題 |
| [`assertThat(page).hasURL()`](/api/class-pageassertions.mdx#page-assertions-to-have-url) | 頁面具有 URL |
