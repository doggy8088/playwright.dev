...
#### 
或者，您也可以在建立瀏覽器情境時，於 [Browser.newContext()](/api/class-browser.mdx#browser-new-context) 中使用 [setRecordHarPath](/api/class-browser.mdx#browser-new-context-option-record-har-path) 選項來錄製 HAR 檔案。這可以擷取整個情境的所有網路流量，直到情境關閉。
