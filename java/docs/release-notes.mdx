...
* 新選項 `setContrast`用於方法[Page.emulateMedia()](/api/class-page.mdx#page-emulate-media) 和 [Browser.newContext()](/api/class-browser.mdx#browser-new-context) 允許 emulate the `prefers-contrast` media feature.
