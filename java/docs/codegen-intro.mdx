...
###### 
<ProgressiveImage image={require("../images/getting-started/record-test-java.png")} alt="錄製測試" />
...
###### 
<ProgressiveImage image={require("../images/getting-started/pick-locator-java.png")} alt="選擇定位器" />
